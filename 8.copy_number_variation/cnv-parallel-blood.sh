...
#BSUB -J cnv-pacbio
#BSUB -G team274
#BSUB -o /lustre/scratch126/cellgen/behjati/lr26/outputs/%J-cnv-pacbio-blood.out
#BSUB -e /lustre/scratch126/cellgen/behjati/lr26/errors/%J-cnv-pacbio-blood.err
...
blood="/lustre/scratch126/cellgen/behjati/lr26/PacBio-aligned/1C01_blood_hifi_reads_pbmm2.bam"
...
### use this function on the sample defined above (e.g. blood)
run_mpileup blood "$blood"
