...
#BSUB -J dmp
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-deepvar-tumor-hg38.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-deepvar-tumor-hg38.err
...
BAM_FILE="/lustre/scratch126/casm/team274sb/lr26/PacBio-aligned-hg38/tumor_1B01_hifi_reads.bam"
...
singularity exec --bind /lustre/scratch126/casm/team274sb/lr26:/mnt \
    ...
    -b "/mnt/PacBio-aligned-hg38/tumor_1B01_hifi_reads.bam" \
    -f "/mnt/hg38/hg38.fa" \
    -o "/mnt/PacBio-deepvariant-tumor-hg38" \
    -p "tumor_output" \
    -t 32 \
    --hifi
