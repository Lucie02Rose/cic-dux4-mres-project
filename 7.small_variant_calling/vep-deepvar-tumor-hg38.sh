...
#BSUB -J vep-tum
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-vep-tum-hg38.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-vep-tum-hg38.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/PacBio-deepvariant-tumor-hg38/tumor_output_norm.vcf.gz"
...
vep \
  ...
  --o "$output_dir/tumor_vep_annotated_with_clinvar_and_dbsnp_vcf_new_hg38.vcf" \
  --vcf \
  --force_overwrite
