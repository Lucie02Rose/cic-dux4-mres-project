...
#BSUB -J vep-tum-som
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-vep-tum-som.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-vep-tum-som.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/PacBio-deepvariant-tumor/isec1/0000.vcf"
...
vep \
  ...
  --o "$output_dir/tumor_vep_annotated_with_clinvar_and_dbsnp_vcf_somatic_new.vcf" \
  --vcf \
  --force_overwrite
