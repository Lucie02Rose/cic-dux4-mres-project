...
#BSUB -J vep-mom
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-vep-mom-hg38.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-vep-mom-hg38.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/PacBio-deepvariant-mom-hg38/mom_output_norm.vcf.gz"
...
vep \
  ...
  --o "$output_dir/mom_vep_annotated_with_clinvar_and_dbsnp_vcf_new_hg38.vcf" \
  --vcf \
  --force_overwrite
