...
#BSUB -J vep-tum
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-vep-tum.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-vep-tum.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/PacBio-deepvariant-tumor/tumor_output_norm.vcf.gz"
...
vep \
  ...
  --o "$output_dir/tumor_vep_annotated_with_clinvar_and_dbsnp_vcf_new.vcf" \
  --vcf \
  --force_overwrite
